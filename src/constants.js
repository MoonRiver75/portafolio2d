...
export const dialogueData = {
    ...
    bed: `Bienvenido a mi cama, no tengo ganas de dormir `,
    resume: `Este es mi CV <a href="https://drive.google.com/drive/folders/1fHHRtv3ZNGy9do0OYGd3F_64NnG58lLk?usp=sharing" target="_blank">Puedes revisarlo</a>
    contactame roldanmadero@gmail.com si tienes alguna vacante!`,
    projects: `Informacion sobre este portafolio: Esta hecho con la biblioteca Kaboom.js, la cual es una biblioteca para crear juegos en JavaScript. El texto se renderiza con HTML/CSS. Por lo tanto, el cuadro de texto que estas leyendo actualmente no se renderiza dentro del lienzo (canvas)`,
